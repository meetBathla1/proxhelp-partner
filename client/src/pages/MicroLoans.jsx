...
const MicroLoans = () => {
  ...
  const products = [
    {
      id: 1,
      bank: 'mPokket',
      name: 'Micro Loan for Students/Pros',
      earnAmount: '120',
      features: [
        { icon: '🎓', text: 'Loan starting from ₹500' },
        { icon: '⚡', text: 'Instant cash in Bank/Paytm' },
        { icon: '📅', text: 'Flexible tenure options' }
      ],
      logo: 'https://www.mpokket.in/images/logo.png'
    },
    {
      id: 2,
      bank: 'SmartCoin',
      ...
      earnAmount: '150',
      features: [
        { icon: '📱', text: '100% Digital Journey' },
        { icon: '⭐', text: 'Trusted by 1Cr+ Users' },
        { icon: '💰', text: 'Low Processing Fees' }
      ],
      logo: 'https://smartcoin.co.in/images/logo.png'
    }
  ];
  ...
  return (
    <div className="micro-loans-page animate-fade-in">
      ...
      <div className="cc-content-list">
        {products.map((product) => (
          <div key={product.id} className="credit-card-item">
            <div className="cc-earn-ribbon teal">
            ...
            <div className="cc-card-header-row">
              ...
              <div className="cc-card-title-group">
                ...
                <span className="cc-product-tag">micro_loan</span>
              </div>
            </div>
