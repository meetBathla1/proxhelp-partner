...
const PersonalLoans = () => {
  ...
  const loans = [
    ...
    },
    {
      id: 2,
      bank: 'Unity Bank',
      name: 'Unity Personal Loan',
      earnAmount: '2.70%',
      features: [
        { icon: '📱', text: 'Approval in just 2 Minutes' },
        { icon: '💡', text: 'No Income Proof Required' },
    ...
    },
    {
      ...
      earnAmount: '2.20%',
      features: [
        { icon: '⚡', text: 'Quick approval & fast disbursal' },
        { icon: '🌐', text: '% digital process' },
        { icon: '💵', text: 'Loan amount up to ₹35 lakh' }
      ],
  ...
  return (
    <div className="personal-loans-page animate-fade-in">
      {/* Header */}
          ...
          <div key={loan.id} className="credit-card-item">
            ...
            <div className="cc-card-header-row">
              ...
              <div className="cc-card-title-group">
                ...
                <span className="cc-product-tag">personal_loan</span>
              </div>
            </div>
