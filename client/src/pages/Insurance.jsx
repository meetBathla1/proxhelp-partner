...
const Insurance = () => {
  ...
  const products = [
    {
      ...
      earnAmount: '15%',
      features: [
        { icon: '🏥', text: 'Cashless Hospitalization' },
        { icon: '🚑', text: '2x Coverage from Day 1' },
        { icon: '📜', text: 'Tax Benefits under 80D' }
      ],
    ...
    },
    {
      ...
      earnAmount: '20%',
      features: [
        { icon: '👨‍👩‍👧', text: 'Life Cover up to ₹2 Crore' },
        { icon: '🩺', text: 'Critical Illness Benefit' },
        { icon: '📅', text: 'Flexible Premium Payment' }
      ],
      logo: 'https://upload.wikimedia.org/wikipedia/commons/1/12/ICICI_Prudential_Life_Insurance_logo.svg'
    }
  ];
  ...
  return (
    <div className="insurance-page animate-fade-in">
      ...
      <div className="cc-content-list">
        {products.map((product) => (
          <div key={product.id} className="credit-card-item">
            <div className="cc-earn-ribbon green">
            ...
            <div className="cc-card-header-row">
              ...
              <div className="cc-card-title-group">
                ...
                <span className="cc-product-tag">insurance</span>
              </div>
            </div>
