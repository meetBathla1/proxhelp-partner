...
const BusinessLoans = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      features: [
        ...
        { icon: '🏦', text: 'Flexible Repayment Terms' },
        { icon: '📱', text: 'Digital Documentation' }
      ],
      logo: 'https://www.lendingkart.com/wp-content/uploads/2019/08/logo.png'
    }
  ];
  ...
  return (
    <div className="business-loans-page animate-fade-in">
      <header className="cc-header-standard">
        <div className="header-left-cc">
          ...
          <div className="header-titles">
            ...
            <span>8 partners available</span>
          </div>
        </div>
      </header>
      ...
      <div className="cc-content-list">
        {products.map((product) => (
          <div key={product.id} className="credit-card-item">
            <div className="cc-earn-ribbon orange">
            ...
            <div className="cc-card-header-row">
              ...
              <div className="cc-card-title-group">
                ...
                <span className="cc-product-tag">business_loan</span>
              </div>
            </div>
